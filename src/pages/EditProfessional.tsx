...
export default function EditProfessional() {
  ...
  const fetchProfessional = async () => {
    try {
      ...
      if (data.user_id !== user?.id) {
        toast({
          title: 'Erro',
          description: 'Você não tem permissão para editar este profissional',
          variant: 'destructive',
        });
      ...
      setFormData({
        ...
        min_price: data.min_price ? data.min_price.toString() : '',
        max_price: data.max_price ? data.max_price.toString() : '',
      ...
      toast({
        title: 'Erro',
        description: 'Falha ao carregar dados do profissional',
        variant: 'destructive',
      });
      navigate('/professionals');
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Erro',
        description: 'Falha ao atualizar profissional. Tente novamente.',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">Editar Profissional</h1>
